        ...
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-2xl">Blog<span className='text-blue-400'>Verse</span></a>
                </div>
                <div className='navbar-end space-x-3'>
                    ...
                    <div className='hidden md:block'>
                        <label className="px-3 py-1 border-rounded-md flex items-center gap-2">
                            <input type="text" className="growline outline-none outline outline-1 outline-500 focus:outline-2" placeholder="Search" />
                    ...
                    <div className="flex space-x-3">
                        <a className="btn px-2 py-3 cursor-pointer bg-blue-400 text-white" onClick={openLoginModal}>Login</a>
                        <a className="btn px-2 py-3 cursor-pointer bg-blue-400 text-white" onClick={openSignupModal}>Sign Up</a>
                    </div>
                </div>
            </div>
            {/* Include the Login and Signup components directly here */}
            <Login />
            <Signup />
        </div>
    );
